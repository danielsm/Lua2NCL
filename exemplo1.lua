...
link:new{ condition = { onEnd = {"img1"} }, action = { start = {"img2"} } }
link:new{ condition = { onEnd = {"img2"} }, action = { start = {"img3"} } }
link:new{ condition = { onEnd = {"img3", interface="anchor1"} }, action = { start = {"img1"} } }
